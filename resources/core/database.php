...
class Database
{
	...
	{
		$this->conn = mysqli_connect(SCIMIFY_DB_SERVER, SCIMIFY_DB_USERNAME, SCIMIFY_DB_PASSWORD, SCIMIFY_DB_NAME) or die("Error: Advanced SCIM Server could not connect to the provided database.".mysqli_connect_error());
